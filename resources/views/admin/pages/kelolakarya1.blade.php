...
<body>
  ...
  <div class="container">
    <div class="sidebar">
      ...
      <a href="kelolakarya.html" class="active">Kelola Karya</a>
  ...
  <h2 class="title-halaman">Kelola Karya</h2>
    <div class="form-container">
      <form>
            ...
            <button class="btn-submit" type="button" onclick="window.location.href='validasikonten.html'"> Validasi</button>
        </form>
    </div>
</div>
  </div>
