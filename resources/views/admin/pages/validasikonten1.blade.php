...
<body>
  ...
  <div class="container">
    <div class="sidebar">
      ...
      <a href="infoprodi.html">Info Prodi</a>
      <a href="validasikonten.html" class="active">Validasi Konten</a>
    ...
    <div class="content">
      ...
      <div class="form-container">
        <form>
          ...
          <button class="btn-submit" type="button" onclick="window.location.href='kelolakarya.html'">Unggah</button>
        </form>
      </div>
    </div>
  </div>
